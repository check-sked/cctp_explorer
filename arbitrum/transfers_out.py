...
CIRCLE_TOKEN_MESSENGER = AsyncWeb3.to_checksum_address('0x19330d10D9Cc8751218eaf51E8885D058642E08A')
...
async def main():
    ...
    await get_cctp_transfers(start_block, end_block, 'arbitrum_transfers_out.csv')
