...
CIRCLE_TOKEN_MESSENGER = AsyncWeb3.to_checksum_address('0x2B4069517957735bE00ceE0fadAE88a26365528f')
...
async def main():
    ...
    await get_cctp_transfers(start_block, end_block, 'optimism_transfers_out.csv')
