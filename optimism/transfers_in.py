...
USDC_ADDRESS = AsyncWeb3.to_checksum_address('0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85')  # USDC on Optimism
...
async def main():
    ...
    await get_cctp_transfers_in(start_block, end_block, 'optimism_transfers_in.csv')
