...
CIRCLE_TOKEN_MESSENGER = AsyncWeb3.to_checksum_address('0x9daF8c91AEFAE50b9c0E69629D3F6Ca40cA3B3FE')
...
async def main():
    ...
    await get_cctp_transfers(start_block, end_block, 'polygon_transfers_out.csv')
